...
class PlayCore {
  ...
  private func realPlay(_ track: Track) {
    let song = track.song
    let baseUrl = URL(string: "http://m801.music.126.net/20220529041210/2758204e10958f3560c12bbb387529d1/jdymusic/obj/wo3DlMOGwrbDjj7DisKw/14096407901/1198/fd35/f521/616c2fa28b06073f8d0609e34e4bb3f8.mp3")
  ...
  private func loadUrls(_ track: Track) {
    ...
    api.songUrl(ids, 9990000).done(on: .main) {
      var preloadUrls = [URL]()
      $0.forEach { song in
